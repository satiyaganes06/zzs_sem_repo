...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2023 at 08:05 AM
...
('647abd738da5d', '021222060133', '$2y$10$/7Z.OZv7erc.WWNzLabP4uorLgn6XUJz4ivsvns.O57IywEcq/FnK', 'Pemohon', 0),
...
('021015080051', 2147483647, 'Kholid', '2023-05-14', 50, 'Lelaki', 'satiyaganes.sg@gmail.com', 'Melayu', '110, Lorong Peramkkku Permai 7, 26600, Pekan, Pahang', '01542222244', '2222222221', 'PHD & Master', 'PROGRAMMERS', 1500.00, '5, Jln 4/1, Perak Darul Ridzuan, Malaysia', '0327378730', NULL),
...
CREATE TABLE `marriage_course_application` (
  ...
  `MPCStatus` varchar(20) NOT NULL,
  `MCResult` varchar(20) NOT NULL,
  `MarriageCourseCertificateNo` varchar(20) NOT NULL,
...
--
-- Dumping data for table `marriage_course_info`
--

INSERT INTO `marriage_course_info` (`Marriage_Course_Id`, `Organize`, `Venue`, `DateStart`, `DateFinish`, `TimeStart`, `TimeFinish`, `StaffName`, `StaffPhoneNumber`, `Notes`, `Capacity`, `Vacancy`) VALUES
(1, 'PEJABAT AGAMA ISLAM KUANTAN', 'DEWAN SEMINAR MASJID NEGERI SU', '2023-06-30', '2023-07-01', '08:00:00', '17:00:00', 'AHMAD KHOLID BIN KHUZAIN', '019598426', 'Khusus ini khas untuk rakyat Malaysia sahaja', 50, 50),
(2, 'PEJABAT AGAMA ISLAM PEKAN', 'DEWAN SEMINAR MASJID JAMEK', '2023-06-22', '2023-06-23', '08:00:00', '17:00:00', 'DANIAL WAFI BIN RAMLI', '0123456789', 'Khusus ini khas untuk rakyat Indonesia sahaja', 50, 50);
...
('645fdb54c787d', '645fdb54b6372', 'AHMAD KHOLID BIN KHUZAIN', '110, Lorong Peramkkku Permai 7, 26600, Pekan, Pahang', '019598426', 'navig543@gmail.com', 'Jaip Staff'),
...
--
-- Table structure for table `witness_info_first`
--

CREATE TABLE `witness_info_first` (
  `Witness_IC_1` varchar(15) NOT NULL,
  `WitnessName_1` varchar(30) NOT NULL,
  `WitnessAddress_1` varchar(50) NOT NULL,
  `WitnessBirthDate_1` date NOT NULL,
  `WitnessAge_1` int(11) NOT NULL,
  `WitnessNumberPhone_1` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `witness_info_second`
--

CREATE TABLE `witness_info_second` (
  `Witness_IC_2` varchar(15) NOT NULL,
  `WitnessName_2` varchar(30) NOT NULL,
  `WitnessAddress_2` varchar(50) NOT NULL,
  `WitnessBirthDate_2` date NOT NULL,
  `WitnessAge_2` int(11) NOT NULL,
  `WitnessNumberPhone_2` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `marriage_course_application`
--
ALTER TABLE `marriage_course_application`
  ADD KEY `Applicant_IC` (`Applicant_IC`),
  ADD KEY `Marriage_Course_Id` (`Marriage_Course_Id`),
...
--
-- Indexes for table `witness_info_first`
--
ALTER TABLE `witness_info_first`
  ADD PRIMARY KEY (`Witness_IC_1`);

--
-- Indexes for table `witness_info_second`
--
ALTER TABLE `witness_info_second`
  ADD PRIMARY KEY (`Witness_IC_2`);
...
--
ALTER TABLE `marriage_course_info`
  MODIFY `Marriage_Course_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
