...
<body>
    ...
    <div class="container-md-8 container-sm-12 row d-flex justify-content-center">
        ...
        <section class="contentPart row p-4 mt-3 bg-white shadow">
            ...
            <div class="loginPart container col-md-4 col-sm-12 pl-5 pr-5 Wshadow rounded-5 text-center">

                <img src="../../Assert/login_top_frame.png" alt="login top frame">

                <h3 class="bold loginTitle mt-4">Admin Log Masuk</h3>
                ...
                <!-- form login -->
                <form class="mt-4" action="../../../public/index.php?action=adminLoginAccount" method="post" id="myform" onsubmit = "return superAdminLoginFormValidate();">
