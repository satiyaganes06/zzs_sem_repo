                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="width: 12%;">
                                            <button type="button" class="btn btn-link btn-sm bg-dark text-light btn-rounded" onclick="location.href='../../../public/index.php?action=getMPCApplicantInfo&from=listOfApplicant'">
                                                Lihat
                                            </button>
                                        </td>
                                    </tr>
