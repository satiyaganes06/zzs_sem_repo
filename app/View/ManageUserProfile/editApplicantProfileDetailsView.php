                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-mdb-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        ...
                                        <a class="list-group-item
                                            ...
                                            list-group-item-light" href="../ManageUserProfile/viewApplicantProfileDetailsView.php">
                                            Lihat Profil
                                        </a>
                                        ...
                                        <a class="list-group-item active
                                            ...
                                            list-group-item-light" href="../ManageUserProfile/editApplicantProfileDetailsView.php">
                                            Edit Profil
                                        </a>
