...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="../css/applicantRegisterView.css">
...
<body>
    ...
    <div class="container-md-8 container-sm-12 row d-flex justify-content-center">
        ...
        <section class="contentPart row p-4 mt-3 bg-white shadow">
            ...
            <div class="loginPart container col-md-4 col-sm-12 pl-5 pr-5 pt-1 shadow rounded-5 text-center">

                <img src="../../Assert/login_top_frame.png" alt="login top frame">

                <h3 class="bold loginTitle mt-4">Daftar</h3>
                ...
                <!-- form register -->
                <form class="" action="../../../public/index.php?action=createAccount" id="myform" method="post" >
